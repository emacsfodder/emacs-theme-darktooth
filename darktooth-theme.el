...
(autothemer-deftheme
                     ...
                     ((((class color) (min-colors #xFFFFFF)) ((class color) (min-colors #xFF)))
                      ...
                      (darktooth-bright_cyan     "#3FD7E5" "color-45")
                      ...
                      (darktooth-faded_cyan      "#00A7AF" "color-37")

                      (darktooth-muted_red       "#901A1E" "color-88")
                      (darktooth-muted_green     "#556C21" "color-100")
                      (darktooth-muted_yellow    "#A87933" "color-136")
                      (darktooth-muted_blue      "#1B5C6B" "color-24")
                      (darktooth-muted_purple    "#82526E" "color-96")
                      (darktooth-muted_aqua      "#506E59" "color-66")
                      (darktooth-muted_orange    "#A24921" "color-130")
                      (darktooth-muted_cyan      "#18A7AF" "color-37")

                      (darktooth-dark_red        "#421E1E" "color-52")
                      (darktooth-dark_green      "#232B0F" "color-22")
                      (darktooth-dark_yellow     "#4D3B27" "color-3")
                      (darktooth-dark_blue       "#2B3C44" "color-4")
                      (darktooth-dark_purple     "#4E3D45" "color-57")
                      (darktooth-dark_aqua       "#36473A" "color-23")
                      (darktooth-dark_orange     "#613620" "color-130")
                      (darktooth-dark_cyan       "#205161" "color-24")

                      (darktooth-mid_red         "#3F1B1B" "color-52")
                      (darktooth-mid_green       "#1F321C" "color-22")
                      (darktooth-mid_yellow      "#4C3A25" "color-3")
                      (darktooth-mid_blue        "#30434C" "color-4")
                      (darktooth-mid_purple      "#4C3B43" "color-57")
                      (darktooth-mid_aqua        "#394C3D" "color-23")
                      (darktooth-mid_orange      "#603000" "color-130")
                      (darktooth-mid_cyan        "#005560" "color-24")
