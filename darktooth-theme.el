...
(autothemer-deftheme
 ...
 (defface darktooth-modeline-active
   `((t
   ...
   "darktooth modeline active")

 (defface darktooth-modeline-inactive
   `((t
...
(defun darktooth-modeline-one ()
  ...
  (set-face-attribute 'mode-line nil
                      :foreground (face-attribute 'darktooth-modeline-active :foreground)
                      :background (face-attribute 'darktooth-modeline-active :background)
                      :height 120
                      :inverse-video nil
                      :box `(:line-width 6 :color ,(face-attribute 'darktooth-modeline-active :background) :style nil))
  (set-face-attribute 'mode-line-inactive nil
                      :foreground (face-attribute 'darktooth-modeline-inactive :foreground)
                      :background (face-attribute 'darktooth-modeline-inactive :background)
                      :height 120
                      :inverse-video nil
                      :box `(:line-width 6 :color ,(face-attribute 'darktooth-modeline-inactive :background) :style nil)))
